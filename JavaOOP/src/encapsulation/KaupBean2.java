...
public class KaupBean2 {
	/*
	 * public 은 은닉화가 되어 있지 않은 상태
	 * 은닉화를 하려면 private 을 넣어야함
	 * 데이터 값은 private 을 넣어야(은닉화) 하고
	...
	public void getIndex() { // 메소드(동사)
		/* [오더]
		 * 카우푸지수는 키와 몸무게를 입력하면 
		 * 저체중...정상...비만 이런식의 결과값을 출력하는 프로그램
		 * 콘솔에 출려되는 문장
		 * [홍길동] 키: 180cm, 몸무게 : 70kg, 카우푸지수 : 정상
		 * 카우푸 공식
		 * (몸무게 / (키*키))*10000  결과값이 30 초과 비만, 24 초과 과체중, 20 초과 정상, 15 초과 저체중, 13 초과 마름, 10 초과 영양실조
		 */
		String name = "", msg = "";
